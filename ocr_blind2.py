def ocr_blind2(file_name = 'test_img.png',
              new_path = 'test_blind_img/',
    ...
    new_name = (os.path.join(new_path, unique_id + img_type))
    print(new_name)
    img = cv2.imread(file_name)
    blinded_img = blind(img, method)
    cv2.imwrite(new_name, blinded_img)
